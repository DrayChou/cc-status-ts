/**
 * Stdin 工具函数 - 从 session stdin 数据中提取有用信息
 */
...
/**
 * 获取带缓冲的 context 百分比 (用于 autocompact 模式)
 */
...
/**
 * 将 SessionInfo 转换为 StdinData
 */
export function sessionToStdinData(session: SessionInfo | null): StdinData {
  if (!session) {
    return {};
  }
  return {
